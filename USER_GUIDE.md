...
- **Time to Sleep**: Set the duration of inactivity before the device automatically goes to sleep; Features a range of options from 1 minute to 4 hours, and "Never" to disable automatic sleep.
